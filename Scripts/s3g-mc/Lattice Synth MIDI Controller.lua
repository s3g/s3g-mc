...
local LABEL_ABBR = {
  ...
  ["GESTURE MUTATION"] = "MUTATE",
  ["BASE FREQUENCY"] = "BASE",
  ["OUTPUT GAIN"] = "OUT",
  ["INGRESS ROW"] = "IN ROW",
  ["INGRESS COLUMN"] = "IN COL",
  ["EGRESS ROW"] = "OUT ROW",
  ["EGRESS COLUMN"] = "OUT COL",
  ["DIVIDER SHADOW"] = "DIV",
  ["FEEDBACK DRIVE"] = "FDBK",
  ...
  ["PITCH MODE"] = "PITCH",
  ["CHANNEL FOCUS"] = "FOCUS",
  ["VELOCITY TO EXCITATION"] = "V EXC",
  ["VELOCITY TO BRIGHTNESS"] = "V BRT",
...
local function section(label, height)
  ...
  ImGui.DrawList_AddRectFilled(draw_list, x, y, x + w, y + 21, THEME.bg_alt)
  ImGui.DrawList_AddRect(draw_list, x, y, x + w, y + height, THEME.edge)
...
local function loop()
  ...
  if visible then
    ...
    if not track or fx < 0 then
      ...
      draw_channels()
      draw_combo("Template", TEMPLATES, PARAM.template)
      ...
      x, y, _, h, stack = section("Table", 232)
      ...
      x, y, _, h, stack = section("Resonator", 238)
      ...
      x, y, _, h, stack = section("MIDI Response", 260)
