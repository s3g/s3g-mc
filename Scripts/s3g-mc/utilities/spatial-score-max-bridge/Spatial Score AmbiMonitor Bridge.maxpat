{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 233.0, 143.0, 1201.0, 650.0 ],
        "description": "Playback bridge for s3g-mc Spatial Score JSON automation. Outputs interpolated AED / distance / gain messages for AmbiMonitor mapping.",
        "tags": "s3g-mc, spatial-score, ambisonics, ambimonitor",
        "boxes": [
            {
                "box": {
                    "id": "obj-3",
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 902.0, 36.0, 35.0, 22.0 ],
                    "text": "clear"
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "text": "print spatial_score_source"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "text": "print spatial_score_position"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "print spatial_score_status"
                                }
                            },
                            {
                                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 673.0, 36.0, 221.0, 22.0 ],
                    "text": "r spatial_score_ambimonitor_messages"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "text": "s3g-mc Spatial Score AmbiMonitor Bridge"
                }
            },
            {
                "box": {
                    ...
                    "text": "Drop a Spatial Score JSON export here. The v8 script reads exported automation points and interpolates them during playback. Generic mode includes gain. ICST mode outputs: aed index azimuth elevation distance."
                }
            },
            {
                "box": {
            ...
            {
                "box": {
                    "filename": "spatial_score_ambimonitor_bridge_v8.js",
                    "id": "obj-v8",
                    "maxclass": "newobj",
                    "numinlets": 1,
                    "numoutlets": 4,
                    ...
                    "text": "v8 spatial_score_ambimonitor_bridge_v8.js",
                    "textfile": {
                        "filename": "spatial_score_ambimonitor_bridge_v8.js",
                        "flags": 0,
                        "embed": 0,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 66.0, 343.0, 223.0, 22.0 ],
                    "text": "s spatial_score_ambimonitor_messages"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 454.0, 249.0, 115.0, 22.0 ],
